...
7. When ready to use, `sudo systemctl start netshare.service`
8. Add to `crontab -e`:
...
9. Start crontab service: `sudo systemctl enable --now cronie`
...
### Using iGPU for hyprland

Follow the instructions here: https://wiki.hypr.land/0.54.0/Configuring/Multi-GPU/
