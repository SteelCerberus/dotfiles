return {
...

  {
    ...
    config = function()
      ...
      -- Enable the following language servers. They are automatically installed.
      ...
      -- Use :Mason to check install status of LSP servers
      require('mason').setup()

      -- You can add other tools here that you want Mason to install (e.g., debuggers, linters)
